...
const fastjet::JetDefinition jet_def(fastjet::antikt_algorithm, 1.0);

//Energy correlation functions
const fastjet::contrib::EnergyCorrelatorC2 ecfC2(1.);
const fastjet::contrib::EnergyCorrelatorD2 ecfD2(1.);
const fastjet::contrib::EnergyCorrelatorDoubleRatio ecfC3(2,1.);
...
struct JetMoments {
  ...
  double Tpruning;
  double Ttrimming;
  double Taktreclustering;
  double Tktreclustering;
 
  void SetAll(JetMoments* new_moments) {
    if (new_moments == NULL) return;
    flavor =           new_moments->flavor;
    pt =               new_moments->pt;
    eta =              new_moments->eta;
    phi =              new_moments->phi;
    m =                new_moments->m;
    Tau21 =            new_moments->Tau21;
    Tau32 =            new_moments->Tau32;
    D2 =               new_moments->D2;
    TJet_m1 =          new_moments->TJet_m1;
    TJet_m2 =          new_moments->TJet_m2;

    T2jet_angle =      new_moments->T2jet_angle;
    T2jet =            new_moments->T2jet;
    T3jet_angle =      new_moments->T3jet_angle;
    T3jet =            new_moments->T3jet;
    Tpruning =         new_moments->Tpruning;
    Ttrimming =        new_moments->Ttrimming;
    Taktreclustering = new_moments->Taktreclustering;
    Tktreclustering =  new_moments->Tktreclustering; 
  }
};
...
JetMoments truth_moments;
JetMoments truthtrim_moments;
JetMoments reco_moments;
JetMoments recotrim_moments;
