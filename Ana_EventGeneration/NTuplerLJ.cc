...
int main(int argc, char* argv[]){
  ...
  treeout->Branch("TruthRawTrim_flavor",        &truthtrim_moments.flavor);
  treeout->Branch("TruthRawTrim_pt",            &truthtrim_moments.pt);
  treeout->Branch("TruthRawTrim_eta",           &truthtrim_moments.eta);
  treeout->Branch("TruthRawTrim_phi",           &truthtrim_moments.phi);
  treeout->Branch("TruthRawTrim_m",             &truthtrim_moments.m);
  treeout->Branch("TruthRawTrim_Tau21",         &truthtrim_moments.Tau21);
  treeout->Branch("TruthRawTrim_Tau32",         &truthtrim_moments.Tau32);
  treeout->Branch("TruthRawTrim_D2",            &truthtrim_moments.D2);
  treeout->Branch("TruthRawTrim_T2jet_angle",   &truthtrim_moments.T2jet_angle);
  treeout->Branch("TruthRawTrim_T2jet",         &truthtrim_moments.T2jet);
  treeout->Branch("TruthRawTrim_T3jet_angle",   &truthtrim_moments.T3jet_angle);
  treeout->Branch("TruthRawTrim_T3jet",         &truthtrim_moments.T3jet);
  treeout->Branch("TruthRawTrim_Tpruning",      &truthtrim_moments.Tpruning);
  treeout->Branch("TruthRawTrim_Ttrimming",     &truthtrim_moments.Ttrimming);
  treeout->Branch("TruthRawTrim_Taktreclustering",	&truthtrim_moments.Taktreclustering);
  treeout->Branch("TruthRawTrim_Tktreclustering",	&truthtrim_moments.Tktreclustering);
  treeout->Branch("TruthRawTrim_TJet_m1",       &truthtrim_moments.TJet_m1);
  treeout->Branch("TruthRawTrim_TJet_m2",       &truthtrim_moments.TJet_m2);

  treeout->Branch("RecoRaw_flavor",        &reco_moments.flavor);
  treeout->Branch("RecoRaw_pt",            &reco_moments.pt);
  treeout->Branch("RecoRaw_eta",           &reco_moments.eta);
  treeout->Branch("RecoRaw_phi",           &reco_moments.phi);
  treeout->Branch("RecoRaw_m",             &reco_moments.m);
  treeout->Branch("RecoRaw_Tau21",         &reco_moments.Tau21);
  treeout->Branch("RecoRaw_Tau32",         &reco_moments.Tau32);
  treeout->Branch("RecoRaw_D2",            &reco_moments.D2);
  treeout->Branch("RecoRaw_T2jet_angle",   &reco_moments.T2jet_angle);
  treeout->Branch("RecoRaw_T2jet",         &reco_moments.T2jet);
  treeout->Branch("RecoRaw_T3jet_angle",   &reco_moments.T3jet_angle);
  treeout->Branch("RecoRaw_T3jet",         &reco_moments.T3jet);
  treeout->Branch("RecoRaw_Tpruning",      &reco_moments.Tpruning);
  treeout->Branch("RecoRaw_Ttrimming",     &reco_moments.Ttrimming);
  treeout->Branch("RecoRaw_Taktreclustering",	&reco_moments.Taktreclustering);
  treeout->Branch("RecoRaw_Tktreclustering",	&reco_moments.Tktreclustering);
  treeout->Branch("RecoRaw_TJet_m1",       &reco_moments.TJet_m1);
  treeout->Branch("RecoRaw_TJet_m2",       &reco_moments.TJet_m2);

  treeout->Branch("RecoRawTrim_flavor",        &recotrim_moments.flavor);
  treeout->Branch("RecoRawTrim_pt",            &recotrim_moments.pt);
  treeout->Branch("RecoRawTrim_eta",           &recotrim_moments.eta);
  treeout->Branch("RecoRawTrim_phi",           &recotrim_moments.phi);
  treeout->Branch("RecoRawTrim_m",             &recotrim_moments.m);
  treeout->Branch("RecoRawTrim_Tau21",         &recotrim_moments.Tau21);
  treeout->Branch("RecoRawTrim_Tau32",         &recotrim_moments.Tau32);
  treeout->Branch("RecoRawTrim_D2",            &recotrim_moments.D2);
  treeout->Branch("RecoRawTrim_T2jet_angle",   &recotrim_moments.T2jet_angle);
  treeout->Branch("RecoRawTrim_T2jet",         &recotrim_moments.T2jet);
  treeout->Branch("RecoRawTrim_T3jet_angle",   &recotrim_moments.T3jet_angle);
  treeout->Branch("RecoRawTrim_T3jet",         &recotrim_moments.T3jet);
  treeout->Branch("RecoRawTrim_Tpruning",      &recotrim_moments.Tpruning);
  treeout->Branch("RecoRawTrim_Ttrimming",     &recotrim_moments.Ttrimming);
  treeout->Branch("RecoRawTrim_Taktreclustering",	&recotrim_moments.Taktreclustering);
  treeout->Branch("RecoRawTrim_Tktreclustering",	&recotrim_moments.Tktreclustering);
  treeout->Branch("RecoRawTrim_TJet_m1",       &recotrim_moments.TJet_m1);
  treeout->Branch("RecoRawTrim_TJet_m2",       &recotrim_moments.TJet_m2);
