...
def SignalBGCompare1D(InputDir, alg, variable, range, logy, pt1, pt2, m1, m2, outputdir):
    ...
    print histname
    hsig = GetHist1D(InputDir+"ntuple_ww.root", "JetTree", histname, range, weight+"*("+alg+"_flavor==1)")
    hbkg = GetHist1D(InputDir+"ntuple_ww.root", "JetTree", histname, range, weight+"*("+alg+"_flavor==-1)")
...
SignalBGCompare1D(InputDir, alg, variable, range, logy, pt1, pt2, m1, m2, outputdir)

c = TCanvas("c","c",200,200)

h1 = GetHist1D(InputDir+"ntuple_ww.root",    "JetTree", "TruthRaw_m", "200,0,200", "")
h2 = GetHist1D(InputDir+"ntuple_ww.root",    "JetTree", "TruthRawTrim_m", "200,0,200", "")
...
rocbox3=myLineBoxText(0.70, 0.85, 4, 1, 1, 0, 0.1, 0.08, "Raw Truth")
rocbox4=myLineBoxText(0.70, 0.80, 2, 1, 1, 0, 0.1, 0.08, "Trimmed Truth")
c.SaveAs(outputdir+"validation_wjets.eps")
